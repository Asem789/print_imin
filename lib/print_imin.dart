...
import 'package:print_imin/print_imin_platform_interface.dart';
...
class PrintImin {
  ...
  Future<bool?> initPrinter() {
    return PrintIminPlatform.instance.initPrinter();
  }
  ...
  Future<String?> getPrinterStatus() {
    return PrintIminPlatform.instance.getPrinterStatus();
  }
  ...
  Future<void> setTextSize(int size) {
    return PrintIminPlatform.instance.setTextSize(size);
  }
  ...
  Future<void> setTextTypeface(IminTypeface typeface) {
    return PrintIminPlatform.instance.setTextTypeface(typeface);
  }
  ...
  Future<void> setTextStyle(IminFontStyle style) {
    return PrintIminPlatform.instance.setTextStyle(style);
  }
  ...
  Future<void> setAlignment(IminPrintAlign alignment) {
    return PrintIminPlatform.instance.setAlignment(alignment);
  }
  ...
  Future<void> setTextWidth(int width) {
    return PrintIminPlatform.instance.setTextWidth(width);
  }
  ...
  Future<void> setTextLineSpacing(double space) {
    return PrintIminPlatform.instance.setTextLineSpacing(space);
  }
  ...
  Future<void> printText(String text, {IminTextStyle? style}) {
    return PrintIminPlatform.instance.printText(text, style: style);
  }
  ...
  Future<void> printAntiWhiteText(String text, {IminTextStyle? style}) {
    return PrintIminPlatform.instance.printAntiWhiteText(text, style: style);
  }
  ...
  Future<void> printColumnsText({
    ...
    return PrintIminPlatform.instance.printColumnsText(cols: cols);
  }
  ...
  Future<void> printAndLineFeed() {
    return PrintIminPlatform.instance.printAndLineFeed();
  }
  ...
  Future<void> printAndFeedPaper(int height) {
    return PrintIminPlatform.instance.printAndFeedPaper(height);
  }
  ...
  Future<void> setPageFormat({int? style}) {
    return PrintIminPlatform.instance.setPageFormat(style: style);
  }
  ...
  Future<void> partialCut() {
    return PrintIminPlatform.instance.partialCut();
  }
  ...
  Future<void> printSingleBitmap(Uint8List img, {IminPrintAlign? alignment}) {
    return PrintIminPlatform.instance
  ...
  Future<void> printSingleBitmapBlackWhite(Uint8List img) {
    return PrintIminPlatform.instance.printSingleBitmapBlackWhite(img);
  }
  ...
  Future<void> setQrCodeSize(int size) {
    return PrintIminPlatform.instance.setQrCodeSize(size);
  }
  ...
  Future<void> setLeftMargin(int margin) {
    return PrintIminPlatform.instance.setLeftMargin(margin);
  }
  ...
  Future<void> setQrCodeErrorCorrectionLev(IminQrcodeCorrectionLevel level) {
    return PrintIminPlatform.instance.setQrCodeErrorCorrectionLev(level);
  }
  ...
  Future<void> setDoubleQRSize(int size) {
    return PrintIminPlatform.instance.setDoubleQRSize(size);
  }
  ...
  Future<void> setDoubleQR1Level(int level) {
    return PrintIminPlatform.instance.setDoubleQR1Level(level);
  }
  ...
  Future<void> setDoubleQR2Level(int level) {
    return PrintIminPlatform.instance.setDoubleQR2Level(level);
  }
  ...
  Future<void> setDoubleQR1MarginLeft(int leftMargin) {
    return PrintIminPlatform.instance.setDoubleQR1MarginLeft(leftMargin);
  }
  ...
  Future<void> setDoubleQR2MarginLeft(int leftMargin) {
    return PrintIminPlatform.instance.setDoubleQR2MarginLeft(leftMargin);
  }
  ...
  Future<void> setDoubleQR1Version(int version) {
    return PrintIminPlatform.instance.setDoubleQR1Version(version);
  }
  ...
  Future<void> setDoubleQR2Version(int version) {
    return PrintIminPlatform.instance.setDoubleQR2Version(version);
  }
  ...
  Future<void> printDoubleQR(
      {required IminDoubleQRCodeStyle qrCode1,
        ...
        int? doubleQRSize}) {
    return PrintIminPlatform.instance.printDoubleQR(
  ...
  Future<void> setBarCodeWidth(int width) {
    return PrintIminPlatform.instance.setBarCodeWidth(width);
  }
  ...
  Future<void> setBarCodeHeight(int height) {
    return PrintIminPlatform.instance.setBarCodeHeight(height);
  }
  ...
  Future<void> setBarCodeContentPrintPos(IminBarcodeTextPos position) {
    return PrintIminPlatform.instance.setBarCodeContentPrintPos(position);
  }
  ...
  Future<void> setInitIminPrinter(bool isDefaultPrinter) {
    return PrintIminPlatform.instance.setInitIminPrinter(isDefaultPrinter);
  }
  ...
  Future<void> resetDevice() {
    return PrintIminPlatform.instance.resetDevice();
  }
}
