...
import 'print_imin_method_channel.dart';

abstract class PrintIminPlatform extends PlatformInterface {
  /// Constructs a PrintIminPlatform.
  PrintIminPlatform() : super(token: _token);

  static final Object _token = Object();

  static PrintIminPlatform _instance = MethodChannelPrintImin();

  /// The default instance of [PrintIminPlatform] to use.
  ///
  /// Defaults to [MethodChannelIminPrinter].
  static PrintIminPlatform get instance => _instance;

  /// Platform-specific implementations should set this with their own
  /// platform-specific class that extends [PrintIminPlatform] when
  /// they register themselves.
  static set instance(PrintIminPlatform instance) {
