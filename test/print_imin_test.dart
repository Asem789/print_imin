...
import 'package:print_imin/column_maker.dart';
import 'package:print_imin/enums.dart';
import 'package:print_imin/imin_style.dart';
import 'package:print_imin/print_imin.dart';
...
void main() {
  final PrintIminPlatform initialPlatform = PrintIminPlatform.instance;

  test('$MethodChannelPrintImin is the default instance', () {
    expect(initialPlatform, isInstanceOf<MethodChannelPrintImin>());
  });

  test('initPrinter', () async {
    PrintImin iminPrinterPlugin = PrintImin();
    MockIminPrinterPlatform fakePlatform = MockIminPrinterPlatform();
    PrintIminPlatform.instance = fakePlatform;
